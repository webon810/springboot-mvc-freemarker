...
import com.sboot.freemailmvc.comsbootfreemailmvc.model.MailProperties;
...
@Service
public class SMTPService implements SendingMailService {

    private final MailProperties mailProperties;

    @Autowired
    SMTPService(MailProperties mailProperties){
